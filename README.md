**S2LSolutions** is a free, open source, flexible project management web application written using CakePHP.
...
#### Installation
    ...
    * Locate your `app` directory, do the changes on following files:
	  * `app/Config/database.php` - We have already updated the database name as "S2LSolutions" which you can change at any point. In order to change it, just create a database using any name and update that name as database in DATABASE_CONFIG section. And also you can set a password for your Mysql login which you will have to update in the same page as password. [Required]
    ...
    * Run the application as http://your-site.com/ from your browser and start using S2LSolutions
...
#### How to Git
	...
	* To contribute, clone the repository to your system/working directory
		...
		* Send a Pull request to S2LSolutions git repository
   ...
   * **Issue Tracker**: [https://github.com/S2LSolutions/orangescrum/issues](https://github.com/S2LSolutions/orangescrum/issues)
