...
if(trim($settings['database']) == "") {
	...
	<head>
		...
		<title>S2LSolutions Setup Wizard</title>
		<style>
		*{
			padding:5;
			margin:5;	
				...
				<table cellpadding="8" cellspacing="8" style="border:1px solid #999999;color:#000000" align="center" width="520px">
					<tr>
						<td align="center" style="border-bottom:1px solid #999999">
							<h3 style="color:#245271">4 simple steps to get started with S2LSolutions</h3>
						</td>
					</tr>
					<tr>
		...
		<div id="container">
			<div id="content">
				...
				<table cellpadding="8" cellspacing="8" style="border:1px solid #999999;color:#000000" align="center" width="520px">
					<tr>
						<td align="center" style="border-bottom:1px solid #999999">
							<h3 style="color:#245271">2 simple steps to get started with S2LSolutions</h3>
						</td>
					</tr>
					<tr>
						<td align="left" style="padding-top:10px">
							<h4>Step1: <span style="font-weight:normal;">You have created a database named "<b>S2LSolutions</b>". But you have no tables in that database. Get the "<b>database.sql</b>" file from the root directory and import that to your database.</span></h4>
