 ...
 */
	function download_sample_csvfile(){
		...
		$myFile ='S2LSolutions_Import_Task_Sample.csv';
		header('HTTP/1.1 200 OK');
        header('Cache-Control: no-cache, must-revalidate');
        header("Pragma: no-cache");
        header("Expires: 0");
        header("Content-type: text/csv");
        header("Content-Disposition: attachment; filename=S2LSolutions_Task_Sample.csv");
...
//                
		...
		$subject = "You have been added to ".$projName." on S2LSolutions";
