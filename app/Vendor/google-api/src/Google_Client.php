...
require 'service/Google_Model.php';
require 'service/Google_Service.php';
require 'service/Google_ServiceResource.php';
require 'auth/Google_AssertionCredentials.php';
require 'auth/Google_Signer.php';
require 'auth/Google_P12Signer.php';
require 'service/Google_BatchRequest.php';
require 'external/URITemplateParser.php';
require 'auth/Google_Auth.php';
require 'cache/Google_Cache.php';
require 'io/Google_IO.php';
require('service/Google_MediaFileUpload.php');
