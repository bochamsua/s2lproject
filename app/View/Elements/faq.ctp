...
<h1  <?php if(!$this->Session->read('Auth.User.id')){ ?>class="big_hd_2"<?php }else{ ?>class="big_hd_1"<?php } ?>>Frequently Asked Questions</h1>
			<!--<div class="sml_hd" style="margin:0px auto;width:585px; text-align:center" align="center">You may have questions, we've tried to address them.<br />If you still have questions, please write to us at <a href='mailto:info@s2lsolutions.com' style="color:#066D99">info@s2lsolutions.com</a></div>
...
Also you can cancel at any time. If you are cancelling in between the billing period, your card will be charged for that entire month, however your account will be canceled with immediate effect.
							...
							<div class="faq_blk">
								...
								<div class="cb"></div>
								<div class="sml_hd_1 faq_ans">
									No problems, <a href="mailto:info@s2lsolutions.com?subject=What if I have a huge team and expecting unlimited activities?" style="text-decoration: none;color: #1e6ea1;">Contact us</a> to avail customized pricing.
							...
							<div class="faq_blk">
								...
								<div class="sml_hd_1 faq_ans">
									...
									<a href="mailto:info@s2lsolutions.com" style="text-decoration: none;color: #1e6ea1;">Contact us</a> for yearly subscription
								</div>
							</div>
							<div class="cb20"></div>
							<div class="faq_blk">
								...
								<div class="cb"></div>
								<div class="sml_hd_1 faq_ans">
									Yes. <a href="mailto:info@s2lsolutions.com?subject=Can I get a Custom Plan which best suits my business?" style="text-decoration: none;color: #1e6ea1;">Contact us</a> to get custom plan for your account.
								</div>
							</div>
							<div class="cb20"></div>
						</diV>	
						...
						<div class="fl" style="padding:5px;">	
							...
							<div class="faq_blk">
								<div class="fl" style="position:relative;">
									...
									<div class="sml_hd faq_qn long_qn fl" style="text-align: left;">Is there any option to have S2LSolutions on my premises?</div>
								...
								<div class="cb"></div>
								<div class="sml_hd_1 faq_ans">
									Of course, we can install S2LSolutions in your environment with a customized price.<br /><a href="mailto:info@s2lsolutions.com?subject=Is there any option to have S2LSolutions on my premises?" style="text-decoration: none;color: #1e6ea1;">Contact us</a>  for on-premise solutions.
