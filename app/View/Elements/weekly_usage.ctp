...
function PrintDiv() {    
	...
	popupWin.document.write('<html><title>S2LSolutions Weekly Usage Report <?php echo date("D, M d",  (strtotime($dateCurnt)-($days_diff*24*60*60)))."&nbsp;-&nbsp;".date("D, M d",strtotime($dateCurnt));?> </title><body onload="window.print()">' + divToPrint.innerHTML + '</html>');
