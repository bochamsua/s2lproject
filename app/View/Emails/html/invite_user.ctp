                   ...
                   <table bgcolor="#FFF" border="0" cellspacing="0" cellpadding="20" width="100%">
                        <tr>
                            <td width="100%" bgcolor="#FFF" style="text-align:left;">
								...
								{
								?>
									<p>You have got an invitation from <a href="mailto:<?php echo $fromEmail; ?>"><?php echo $fromName; ?></a> to join <?php echo $company_name; ?>  on S2LSolutions.</p>
								...
								?>
									<p><a href="mailto:<?php echo $fromEmail; ?>"><?php echo $fromName; ?></a> has just setup an account for you on S2LSolutions.</p>
									<p>Please click the button below to get started.</p>
									
									<a style="font-weight:bold; text-decoration:none;" href="<?php echo HTTP_ROOT.'users/invitation/'.$qstr;?>" target='_blank'><div style="display:block; max-width:100% !important; width:auto !important;margin:auto; height:auto !important;background-color:#0EA426;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;border-radius:10px;color:#ffffff;font-size:16px;text-align:center">Get started with S2LSolutions</div></a>
								<?php
								}
								?>
								...
								<p>If you have any questions, please write us at <a href='mailto:info@s2lsolutions.com'>info@s2lsolutions.com</a>, we will be happy to help you.</p>
								
								<br/>
								
								<p>Regards,<br/>
								The S2LSolutions Team</p>
                            </td>
                        </tr>
                   </table>
                        ...
                        <tr>
                            <td width="100%" bgcolor="#ffffff" style="text-align:center;">
                            	<p style="color:#222222; font-family:Arial, Helvetica, sans-serif; font-size:11px; line-height:14px; margin-top:0; padding:0; font-weight:normal;padding-top:5px;">
									...
									{
									?>
										You are receiving this email notification because you have subscribed to S2LSolutions, to unsubscribe, please email with subject 'Unsubscribe' to <a href='mailto:info@s2lsolutions.com'>info@s2lsolutions.com</a>
									<?php
									}
									else {
									?>
										Your email address is used to invite you on S2LSolutions. If you didn't intend to do this, just ignore this email; no account has been created yet.
									<?php
									}
									?>
                                </p>
