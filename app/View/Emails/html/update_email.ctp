			...
			<tr>
				...
				<table bgcolor="#FFF" border="0" cellspacing="0" cellpadding="20" width="100%">
					...
					<td width="100%" bgcolor="#FFF" style="text-align:left;">
					    ...
					    <p>We've received a request to change the email address associated with your S2LSolutions account. Please click the button below to confirm this email address. After confirmation, this will be your Login email address of S2LSolutions.</p>
