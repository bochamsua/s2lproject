...
<div class="steps_os">
	<div class="steps_usr">
		<h1 style="color: #428BCA;">Welcome <?php echo USERNAME; ?>!<br/> Get started with your S2LSolutions account</h1>
		<h6 style="color: #D67866;font-size: 17px;">You're just 3 simple steps away from exploring S2LSolutions!</h6>
	</div>
...
<!--						<th>
			...
			<td class="onbrd_rt">
				...
				<?php }elseif($totalusers<=1){?>
					...
					S2LSolutions works best when you add your Co-workers.</h4>
				...
				<?php }else{ $autorefreshflag =1;?>
						<h4 style="text-shadow:none; font-size: 26px;text-align:center">Wow! You have completed all the basics of S2LSolutions.<br/>
						Now you can get started with S2LSolutions.</h4><br/>
