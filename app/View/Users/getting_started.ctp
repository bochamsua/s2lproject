...
<div class="get_started_outer">
    <?php if(SES_TYPE<3) { ?>
    <div class="get_hd_bg">Getting Started with S2LSolutions</div>
    <div class="get_det">
    ...
    <div class="get_det">
        ...
        <div class="get_text fl">
            ...
            <ul style="padding:5px 15px;margin-top:0px;">
                <li>
                    You can respond to the task Email sent from info@s2lsolutions.com.
                </li>
                <li>
                    Your Email response will be posted on S2LSolutions against that task.
                </li>
                <li>
    ...
    <div class="get_det">
        ...
        <div class="get_text fl">
            ...
            <ul style="padding:5px 15px;margin-top:0px;">
                ...
                <li>
                   You'll see a pop-up when a new task or reply arrives so you can keep track of your Tasks even when you're not looking at S2LSolutions.
                </li>
                <li>
    ...
    <div class="get_det">
        ...
        <div class="get_text fl">
            ...
            <ul style="padding:5px 15px;margin-top:0px;">
                <li>
                    Personalize your S2LSolutions account by setting up your Profile details and Timezone.
                </li>
                <li>
	...
	<a class="get_title" href="<?php echo HTTP_ROOT; ?>users/email_notifications" style="font-size: 14px;">
        ...
        <div class="get_text fl">
            ...
            <ul style="padding:5px 15px;margin-top:0px;">
                ...
                <li>
                    Set to "Yes", to get all the Task related Emails from all your assigned projects from S2LSolutions.
                </li>
                <li>
