			...
			<div class="right_panel_list fl">
				...
				elseif($tour == "task-template") { ?>
					...
					<ul class="classli">
						...
						<li>S2LSolutions provides some default Task Templates.</li>
						<li>No formatting required every time you create Daily Updates, Meeting Minutes, Status updates or Bugs on S2LSolutions</li>
					</ul>
					<div class="cb" align="center">
				...
				?>
					...
					<ul class="classli">
						...
						<li>Trim down S2LSolutions storage usage</li>
