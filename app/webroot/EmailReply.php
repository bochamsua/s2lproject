...
//print '<pre>';print_r($email_res);
			...
			if ( $num_rows < 1 ) {
				...
				send_email(INFO_MAIL, '', "Failed to save Email reply in S2LSolutions", $Failedmessage);
				continue;*/
			}		
...
//subject of the mail to be sent
                            ...
                            //$subject = "Re: [S2LSolutions]:" . $projNameInSh . ":#" . $row['case_no'] . "(" . $pj_sname . ")" . "-" . stripslashes(html_entity_decode($row['title'], ENT_QUOTES));
...
<a href='".HTTP_ROOT."' target='_blank' style='font:11px verdana;text-decoration:underline;'>S2LSolutions</a>
</td>
</tr>
</table>
</td>
...
";
			...
			$userMsg1 = "";
                        ...
                        $userMsg = '<span>This email: &quot;' . $mail_id . '&quot; is not registered with S2LSolutions.</span><br /><br />';
                        $userMsg1 = '<span>Note: <b>To post a reply to this task, please use your S2LSolutions login Email ID</b>.</span><br /><br />';
                    }
...
<tr>
<td align="left" style="font:9px Verdana;padding-top:2px;color:#737373" colspan="2">
You are receiving this email notification because you have subscribed to S2LSolutions, to unsubscribe, please email with subject \'Unsubscribe\' to <a href="mailto:'.SUPPORT_EMAIL.'">'.SUPPORT_EMAIL.'</a>
</td>	  
</tr>
</table>
</td>
...
function write2log($why, $message, $mail_id, $subject, $date) {
    ...
    send_email(DEV_EMAIL, '', "Failed to save Email reply in S2LSolutions", $message);
}
